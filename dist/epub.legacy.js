...
var continuous_ContinuousViewManager = /*#__PURE__*/function (_DefaultViewManager) {
  ...
  continuous_createClass(ContinuousViewManager, [{
    ...
    value: function syncScrollPosition() {
      var _this$getScrollPositi = this.getScrollPosition(),
          top = _this$getScrollPositi.top,
          left = _this$getScrollPositi.left;
      ...
      for (var i = 0; i < viewsLength; i++) {
        ...
        if (isVisible === true) {
          ...
          if (!view.displayed) {
            ...
            if (view.element && view.element.style.visibility !== "visible" || view.iframe && view.iframe.style.visibility !== "visible") {
              view.show();
            }
          }
          ...
          if (view.displayed && view.element && view.element.style.visibility !== "hidden") {
            view.hide();
          }
    ...
    value: function check(_offsetLeft, _offsetTop) {
      ...
      var _this$syncScrollPosit = this.syncScrollPosition(),
          top = _this$syncScrollPosit.top,
          left = _this$syncScrollPosit.left;

      var offset = horizontal ? left : top;
    ...
    value: function addScrollListeners() {
      ...
      var _this$syncScrollPosit2 = this.syncScrollPosition(),
          top = _this$syncScrollPosit2.top,
          left = _this$syncScrollPosit2.left;
    ...
    key: "onScroll",
    value: function onScroll() {
      var _this$syncScrollPosit3 = this.syncScrollPosition(),
          scrollTop = _this$syncScrollPosit3.top,
          scrollLeft = _this$syncScrollPosit3.left;
    ...
    value: function scrolled() {
      var scrolledTask = this.q.enqueue(function () {
        return this.check();
      }.bind(this));
      this.scrolledRequestId = (this.scrolledRequestId || 0) + 1;
      var requestId = this.scrolledRequestId;
      this.emit(constants["c" /* EVENTS */].MANAGERS.SCROLL, {
        top: this.scrollTop,
        left: this.scrollLeft
      });
